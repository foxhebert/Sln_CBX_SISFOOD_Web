...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgDuplicateFile: 'El documento "{name}" del mismo tamaño "{size} KB" ya fue añadido. Evitar archivos duplicados.', //HGM 15.11.2021
        //msgDuplicateFile: 'File "{name}" of same size "{size} KB" has already been selected earlier. Skipping duplicate selection.', //HGM
